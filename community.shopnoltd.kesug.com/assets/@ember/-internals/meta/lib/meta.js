    ...
    class Meta {
        ...
        pushListener(event, target, method, kind, sync) {
            ...
            if (i === -1) {
                ...
                (false && !(!(!this.isPrototypeMeta(this.source) && typeof method === 'function' && kind === 2 /* ListenerKind.REMOVE */ )) && (0, _debug.assert)('You attempted to remove a function listener which did not exist on the instance, which means you may have attempted to remove it before it was added.', !(!this.isPrototypeMeta(this.source) && typeof method === 'function' && kind === 2)));
                listeners.push({
                    event,
                    target,
                    method,
                ...
                (false && !(listener) && (0, _debug.assert)('has listener', listener)); // If the listener is our own listener and we are trying to remove it, we
    ...
    */
    ...
    function indexOfListener(listeners, event, target, method) {
        for (var i = listeners.length - 1; i >= 0; i--) {
            var listener = listeners[i];
            (false && !(listener) && (0, _debug.assert)('has listener', listener));
