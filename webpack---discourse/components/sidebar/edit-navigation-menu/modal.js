...
export default class SidebarEditNavigationMenuModal extends Component {
    ...
    filterDropdownContent = [{
        ...
        {
            id: "selected",
            name: I18n.t("sidebar.edit_navigation_modal_form.filter_dropdown.selected")
        },
        {
            id: "unselected",
            name: I18n.t("sidebar.edit_navigation_modal_form.filter_dropdown.unselected")
        }
    ];
    @action
    onFilterDropdownChange(value1) {
        this.filterDropdownValue = value1;
        switch (value1) {
            case "all":
