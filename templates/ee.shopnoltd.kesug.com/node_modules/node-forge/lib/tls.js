...
tls.parseHelloMessage = function(c, record, length) {
    ...
    if (length < 38) {
        c.error(c, {
            message: client ?
                'Invalid ServerHello message. Message too short.' : 'Invalid ClientHello message. Message too short.',
            send: true,
            alert: {
                level: tls.Alert.Level.fatal,
...
tls.handleCertificate = function(c, record, length) {
    ...
    if ((client || c.verifyClient === true) && certs.length === 0) {
        ...
        c.error(c, {
            message: client ?
                'No server certificate provided.' : 'No client certificate provided.',
            send: true,
            alert: {
                level: tls.Alert.Level.fatal,
                description: tls.Alert.Description.illegal_parameter
