...
Many PHP developers need to send email from their code. The only PHP function that supports this directly is [`mail()`](https://www.html.net/manual/en/function.mail.html). However, it does not provide any assistance for making use of popular features such as authentication, HTML messages, and attachments.
...
While installing the entire package manually or with Composer is simple, convenient, and reliable, you may want to include only vital files in your project. At the very least you will need [src/PHPMailer.html](https://github.com/PHPMailer/PHPMailer/tree/master/src/PHPMailer.html). If you're using SMTP, you'll need [src/SMTP.html](https://github.com/PHPMailer/PHPMailer/tree/master/src/SMTP.html), and if you're using POP-before SMTP (*very* unlikely!), you'll need [src/POP3.html](https://github.com/PHPMailer/PHPMailer/tree/master/src/POP3.html). You can skip the [language](https://github.com/PHPMailer/PHPMailer/tree/master/language/) folder if you're not showing errors to users and can make do with English-only errors. If you're using XOAUTH2 you will need [src/OAuth.html](https://github.com/PHPMailer/PHPMailer/tree/master/src/OAuth.html) as well as the Composer dependencies for the services you wish to authenticate with. Really, it's much easier to use Composer!
...
We welcome corrections and new languages – if you're looking for corrections, run the [Language/TranslationCompletenessTest.html](https://github.com/PHPMailer/PHPMailer/blob/master/test/Language/TranslationCompletenessTest.html) script in the tests folder and it will show any missing translations.
...
You can generate complete API-level documentation by running `phpdoc` in the top-level folder, and documentation will appear in the `docs` folder, though you'll need to have [PHPDocumentor](https://www.htmldoc.org) installed. You may find [the unit tests](https://github.com/PHPMailer/PHPMailer/blob/master/test/PHPMailer/PHPMailerTest.html) a good reference for how to do various operations such as encryption.
