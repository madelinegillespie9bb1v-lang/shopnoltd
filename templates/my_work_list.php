...
require_once $_SERVER['DOCUMENT_ROOT'].'/_common_rates_worker.php'; // worker-specific rates
...
// ✅ Fetch all jobs worked on by this user
try {
    $stmt = $pdo->prepare("
...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3>📝 My Completed / In-progress Work (<?= count($works) ?>)</h3>
        <a href="<?= ($user_role === 'admin') ? '/admindashboard.php' : '/dashboard.php' ?>" class="btn btn-secondary">⬅ Back</a>
    </div>
