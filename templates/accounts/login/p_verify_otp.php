...
if (!isset($_SESSION['pending_user'])) {
    echo "<script>alert('No registration data found. Please register again.');window.location.href='index.php';</script>";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($entered_otp == $otp_generated) {
        ...
        echo "<meta http-equiv='refresh' content='2;url=" . BASE_URL . "/accounts/login/index.php'>";
        exit;
    } else {
