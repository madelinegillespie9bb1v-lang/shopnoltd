window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "cs_project_id": null,
    "account_id": 157824,
    "account_signature": "01a544f1dd040ab849b64ad54dd376dc5eed116fe58e13b14ef5ad7193f3eb56"
};
...
! function() {
    ...
    var o, s = function() {
        ...
        f = function(e, t) {
            ...
            return "lab" === e && (n = l.browser.inLab), "field" === e && (n = c.isFieldMetricsEnabled), t ? n && t.flush : n
        },
        h = function(e) {
            var t = !1,
                n = "v=".concat(l.version),
                r = "".concat(l.metricsUrl, "?").concat(n, "&site_id=").concat(window.hjSiteSettings.site_id) + (c.isDebugEnabled ? "&debug=true" : ""),
                i = JSON.stringify(e);
            ...
            start: function() {
                try {
                    ...
                    return c.genericTags = {
                        site_id: r
                    }, c.isDebugEnabled = Math.random() <= u.universalDebug || a.has("client_script.metrics.debug") && Math.random() <= u.debug, c.isMetricsEnabled = Math.random() <= u.metrics, c.isFieldMetricsEnabled = c.isMetricsEnabled && Math.random() <= u.fieldMetrics, o = new i(h, l.buffer.bufferSize, l.buffer.flushInterval), e
                } catch (e) {
            ...
            count: function(e, t) {
                ...
                try {
                    var l, u = d(r),
                        h = c.loggedMetrics[e],
                        p = 0;
                    if (n ? (p = (h && h[u] || 0) + (n.value || 1), c.loggedMetrics[e] = a(a({}, h), {}, ((l = {})[u] = null != n && n.flush ? 0 : p, l))) : p = 1, f(s, n)) {
                        var m = {
                            name: e,
                            type: "count",
                            value: p,
    ...
    if (window.hjLazyModules = window.hjLazyModules || {
            ...
            USER_TEST: {
                js: "user-test.533a6ad28639d0d9369f.js"
            }
        ...
        var c = window.document,
            u = c.head || c.getElementsByTagName("head")[0];
        hj.scriptDomain = e;
        var d = c.createElement("script");
        d.async = 1, d.src = hj.scriptDomain + t, d.charset = "utf-8", u.appendChild(d), l.revision = "4945b8f", window.hjBootstrap = l
    }, window.hjBootstrap("https://script.hotjar.com/", "modules.bcf765a6884e76e4baf2.js", "1398434"), hj.metrics.timeEnd("resource-blocking-time", {
        tag: {
            resource: "hotjar-js"
        },
        start: k,
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            n = (new Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "4045aa55-7e95-58bb-a2c5-eec1a5ef1b57")
    } catch (e) {}
}();
//# debugId=4045aa55-7e95-58bb-a2c5-eec1a5ef1b57