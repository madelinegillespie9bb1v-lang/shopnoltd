    ...
    */
    ...
    function initialize(obj, properties) {
        ...
        if (properties !== undefined) {
            ...
            for (var keyName of keyNames) {
                ...
                (false && !(!(keyName === 'actions' && _runtime.ActionHandler.detect(obj))) && (0, _debug.assert)('`actions` must be provided at extend time, not at create time, ' + 'when Ember.ActionHandler is used (i.e. views, controllers & routes).', !(keyName === 'actions' && _runtime.ActionHandler.detect(obj))));
    ...
    class CoreObject {
        constructor(owner) {
            ...
            var self;
            if (false /* DEBUG */ && (0, _metal.hasUnknownProperty)(this)) {
