    ...
    class EmberRouter extends _object.default.extend(_evented.default) {
        ...
        */
        ...
        static _routePath(routeInfos) {
            ...
            for (var i = 1; i < routeInfos.length; i++) {
                ...
                (false && !(routeInfo) && (0, _debug.assert)('has routeInfo', routeInfo));
                name = routeInfo.name;
        ...
        constructor(owner) {
            ...
            var bucketCache = owner.lookup((0, _container.privatize)
                `-bucket-cache:main`);
            (false && !(bucketCache instanceof _internals.BucketCache) && (0, _debug.assert)('BUG: BucketCache should always be present', bucketCache instanceof _internals.BucketCache));
        ...
        _initRouterJs() {
            ...
            (false && !(owner) && (0, _debug.assert)('Router is unexpectedly missing an owner', owner));
            ...
            class PrivateRouter extends _router_js.default {
                getRoute(name) {
                    ...
                    (false && !(routeOwner) && (0, _debug.assert)('Route is unexpectedly missing an owner', routeOwner));
        ...
        */
        ...
        _setOutlets() {
            ...
            if (!this._toplevelView) {
                var owner = (0, _owner.getOwner)(this);
                (false && !(owner) && (0, _debug.assert)('Router is unexpectedly missing an owner', owner)); // SAFETY: we don't presently have any type registries internally to make
                ...
                (false && !(OutletView !== undefined) && (0, _debug.assert)('[BUG] unexpectedly missing `view:-outlet`', OutletView !== undefined));
                var application = owner.lookup('application:main');
                (false && !(application !== undefined) && (0, _debug.assert)('[BUG] unexpectedly missing `application:-main`', application !== undefined));
                var environment = owner.lookup('-environment:main');
                (false && !(environment !== undefined) && (0, _debug.assert)('[BUG] unexpectedly missing `-environment:main`', environment !== undefined));
                var template = owner.lookup('template:-outlet');
                (false && !(template !== undefined) && (0, _debug.assert)('[BUG] unexpectedly missing `template:-outlet`', template !== undefined));
        ...
        */
        ...
        intermediateTransitionTo(name) {
            ...
            if (false /* DEBUG */ ) {
                ...
                if (this.namespace.LOG_TRANSITIONS) {
                    (false && !(infos) && (0, _debug.assert)('expected infos to be set', infos)); // eslint-disable-next-line no-console
        ...
        */
        ...
        willDestroy() {
            ...
            for (var name in instances) {
                ...
                (false && !(instanceMap) && (0, _debug.assert)('has instanceMap', instanceMap));
                for (var id in instanceMap) {
                    var instance = instanceMap[id];
                    (false && !(instance) && (0, _debug.assert)('has instance', instance));
        ...
        */
        ...
        _setupLocation() {
            ...
            if ('string' === typeof location) {
                ...
                (false && !(resolvedLocation) && (0, _debug.assert)(`Could not resolve a location class at 'location:${location}'`, resolvedLocation));
        ...
        */
        _hydrateUnsuppliedQueryParams(state, queryParams, _fromRouterService) {
            ...
            for (var routeInfo of routeInfos) {
                ...
                for (var j = 0, qpLen = qpMeta.qps.length; j < qpLen; ++j) {
                    qp = qpMeta.qps[j];
                    (false && !(qp) && (0, _debug.assert)('expected qp', qp));
        ...
        _getEngineInstance(_ref) {
            ...
            // We just set these!
            (false && !(namedInstances) && (0, _debug.assert)('has namedInstances', namedInstances));
            var engineInstance = namedInstances[instanceId];
            if (!engineInstance) {
                var owner = (0, _owner.getOwner)(this);
                (false && !(owner instanceof _instance.default) && (0, _debug.assert)('Expected router to have EngineInstance as owner', owner instanceof _instance.default));
    ...
    */
    ...
    function triggerEvent(routeInfos, ignoreFailure, name, args) {
        ...
        for (var i = routeInfos.length - 1; i >= 0; i--) {
            ...
            (false && !(routeInfo) && (0, _debug.assert)('[BUG] Missing routeInfo', routeInfo));
            ...
            if (actionHandler) {
                if (actionHandler.apply(handler, args) === true) {
                    ...
                    if (name === 'error') {
                        (false && !(handler) && (0, _debug.assert)('[BUG] Missing handler', handler));
    ...
    function updatePaths(router) {
        ...
        (false && !(info) && (0, _debug.assert)('expected info', info));
