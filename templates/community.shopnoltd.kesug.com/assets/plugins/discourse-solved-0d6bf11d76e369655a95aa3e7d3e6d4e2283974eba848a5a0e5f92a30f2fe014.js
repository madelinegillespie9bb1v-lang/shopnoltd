define("discourse/plugins/discourse-solved/discourse/connectors/bread-crumbs-right/solved-status-filter", ["exports", "@glimmer/component", "@ember/object", "@ember/service", "discourse-common/lib/get-owner", "I18n"], (function(e, t, s, o, i, a) {
    "use strict"
    ...
    class r extends t.default {
        static shouldRender(e, t) {
            const s = (0, i.getOwnerWithFallback)(this).lookup("service:router")
            return !(!t.siteSettings.show_filter_by_solved_status || "discovery.categories" === s.currentRouteName || e.editingCategory) && (!(!t.siteSettings.allow_solved_on_all_topics && "tag.show" !== s.currentRouteName) || e.currentCategory ? .enable_accepted_answers)
        }
        static# e = (() => dt7948.g(this.prototype, "router", [o.inject]))()# t = (() => {
            dt7948.i(this, "router")
        })()
        static# s = (() => dt7948.g(this.prototype, "siteSettings", [o.inject]))()# o = (() => {
            dt7948.i(this, "siteSettings")
        })()
        get statuses() {
            return ["all", "solved", "unsolved"].map((e => ({
                name: a.default.t(`solved.topic_status_filter.${e}`),
                value: e
            })))
        }
        get status() {
            const e = this.router.currentRoute.queryParams ? .solved
            return n[e] || "all"
        }
        changeStatus(e) {
        ...
        static# i = (() => dt7948.n(this.prototype, "changeStatus", [s.action]))()
    }
    e.default = r
    ...
    e.default = {
        actions: {
            onChangeSetting(e) {
                this.set("category.custom_fields.enable_accepted_answers", e ? "true" : "false")
            }
        }
    }
    ...
    const o = 6048e5,
        i = o,
        a = (0, s.isTesting)() ? 0 : 2e3
    e.default = {
        shouldRender: (e, t) => !t.site.mobileView,
        setupComponent(e, s) {
            s.set("show", !1), s.setProperties({
                oneWeek: o,
                show: !1
            }), (0, t.later)((() => {
                if (!s.element || s.isDestroying || s.isDestroyed) return
                const t = e.topic,
                    o = s.currentUser!t.accepted_answer && o && t.user_id === o.id && moment() - moment(t.created_at) > i && t.postStream.posts.some((e => e.user_id !== o.id && e.can_accept_answer)) && s.set("show", !0)
            }), a)
        }
    }
})), define("discourse/plugins/discourse-solved/discourse/connectors/user-activity-bottom/solved-list", ["exports", "@glimmer/component", "@ember/service"], (function(e, t, s) {
    "use strict"
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0
    class o extends t.default {
        static# e = (() => dt7948.g(this.prototype, "siteSettings", [s.inject]))()# o = (() => {
            dt7948.i(this, "siteSettings")
        })()
    }
    e.default = o
})), define("discourse/plugins/discourse-solved/discourse/connectors/user-summary-stat/solved-count", ["exports", "@glimmer/component", "@ember/service"], (function(e, t, s) {
    "use strict"
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0
    ...
    e.default = o
})), define("discourse/plugins/discourse-solved/discourse/initializers/add-topic-list-class", ["exports", "discourse/components/topic-list-item", "discourse-common/utils/decorators"], (function(e, t, s) {
    "use strict"
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0
    e.default = {
        ...
        initialize() {
            t.default.reopen(dt7948.p({
                unboundClassNames() {
                    let e = this._super(...arguments)
                    return this.topic.has_accepted_answer && (e += " status-solved"), e
                }
            }, [
                ["method", "unboundClassNames", [(0, s.default)()]]
            ]))
        }
    }
})), define("discourse/plugins/discourse-solved/discourse/initializers/extend-for-solved-button", ["exports", "@ember/object", "discourse/helpers/topic-status-icons", "discourse/lib/ajax", "discourse/lib/ajax-error", "discourse/lib/plugin-api", "discourse/lib/utilities", "discourse/models/topic", "discourse/models/user", "discourse/raw-views/topic-status", "discourse/widgets/post-cooked", "discourse-common/lib/icon-library", "I18n"], (function(e, t, s, o, i, a, c, n, r, l, d, u, p) {
    "use strict"

    function f(e) {
        const t = e.getCurrentUser()
        s.default.addObject(["has_accepted_answer", "far-check-square", "solved"]), e.includePostAttributes("can_accept_answer", "can_unaccept_answer", "accepted_answer", "topic_accepted_answer"), e.addDiscoveryQueryParam && e.addDiscoveryQueryParam("solved", {
            replace: !0,
            refreshModel: !0
        }), e.addPostMenuButton("solved", (e => {
            if (e.can_accept_answer) {
                return {
                    action: "acceptAnswer",
                    icon: "far-check-square",
                    className: "unaccepted",
                    title: "solved.accept_answer",
                    label: t ? .id === e.topicCreatedById ? "solved.solution" : null,
                    position: e.topic_accepted_answer ? "second-last-hidden" : "first"
                }
            }
            if (e.accepted_answer) return e.can_unaccept_answer ? {
                ...
                disabled: "true",
                position: "first",
                beforeButton: e => e("span.accepted-text", {
                    title: p.default.t("solved.accepted_description")
                }, [e("span", (0, u.iconNode)("check")), e("span.accepted-label", p.default.t("solved.solution"))])
            }
            ...
            if (1 === e.attrs.post_number) {
                ...
                if (t) {
                    ...
                    if (s.accepted_answer) {
                        const t = !!s.accepted_answer.excerpt,
                        ...
                        return e.rawHtml(a.init())
                    }
                }
            }
        })), e.attachWidgetAction("post", "acceptAnswer", (function() {
            const e = this.model;
            (function(e) {
                const t = e.topic;
                (function(e) {
                    e.get("postStream.posts").forEach((e => {
                        e.get("post_number") > 1 && e.setProperties({
                            accepted_answer: !1,
                            can_accept_answer: !0,
                            can_unaccept_answer: !1,
                            topic_accepted_answer: !1
                        })
                    }))
                })(t), e.setProperties({
                    can_unaccept_answer: !0,
                    can_accept_answer: !1,
                    accepted_answer: !0
                }), t.set("accepted_answer", {
                    username: e.username,
                    name: e.name,
                    post_number: e.post_number,
                    excerpt: e.cooked
                }), (0, o.ajax)("/solution/accept", {
                    type: "POST",
                    data: {
                        id: e.id
                    }
                }).catch(i.popupAjaxError)
            })(e), this.appEvents.trigger("discourse-solved:solution-toggled", e), e.get("topic.postStream.posts").forEach((e => {
                e.set("topic_accepted_answer", !0), this.appEvents.trigger("post-stream:refresh", {
                    id: e.id
                })
            }))
        })), e.attachWidgetAction("post", "unacceptAnswer", (function() {
            const e = this.model;
            (function(e) {
                ...
                e.setProperties({
                    ...
                    can_unaccept_answer: !1,
                    accepted_answer: !1
                }), t.set("accepted_answer", void 0), (0, o.ajax)("/solution/unaccept", {
                    type: "POST",
                    data: {
                        id: e.id
                    }
                ...
                e.set("topic_accepted_answer", !1), this.appEvents.trigger("post-stream:refresh", {
                    id: e.id
                })
            }))
        }))
    ...
    e.default = {
        ...
        initialize() {
            n.default.reopen({
                acceptedAnswerHtml: (0, t.computed)("accepted_answer", "id", (function() {
                    const e = this.get("accepted_answer.username"),
                        t = this.get("accepted_answer.name"),
                        s = this.get("accepted_answer.post_number")
                    if (!e || !s) return ""
                    const o = this.siteSettings.display_name_on_posts && t ? t : (0, c.formatUsername)(e)
                    return p.default.t("solved.accepted_html", {
                        icon: (0, u.iconHTML)("check-square", {
                            class: "accepted"
                        }),
                        username_lower: e.toLowerCase(),
                        username: o,
                        post_path: `${this.url}/${s}`,
                        post_number: s,
                        user_path: r.default.create({
                            username: e
                        }).path
                    })
                }))
            }), l.default.reopen({
                statuses: (0, t.computed)((function() {
                    const e = this._super(...arguments)
                    return this.topic.has_accepted_answer ? e.push({
                        openTag: "span",
                        closeTag: "span",
                        title: p.default.t("topic_statuses.solved.help"),
                        icon: "far-check-square",
                        key: "solved"
                    }) : this.topic.can_have_answer && this.siteSettings.solved_enabled && this.siteSettings.empty_box_on_unsolved && e.push({
                        openTag: "span",
                        closeTag: "span",
                        title: p.default.t("solved.has_no_accepted_answer"),
                        icon: "far-square"
                    }), e
                }))
            }), (0, a.withPluginApi)("0.1", f), (0, a.withPluginApi)("0.8.10", (e => {
                e.replaceIcon("notification.solved.accepted_notification", "check-square")
            })), (0, a.withPluginApi)("0.11.0", (e => {
                e.addAdvancedSearchOptions({
                    statusOptions: [{
                        name: p.default.t("search.advanced.statuses.solved"),
                        value: "solved"
                    }, {
                        name: p.default.t("search.advanced.statuses.unsolved"),
                        value: "unsolved"
                    }]
                })
            })), (0, a.withPluginApi)("0.11.7", (e => {
                e.addSearchSuggestion("status:solved"), e.addSearchSuggestion("status:unsolved")
            }))
        }
    }
})), define("discourse/plugins/discourse-solved/discourse/pre-initializers/extend-category-for-solved", ["exports", "@ember/object", "discourse/models/category"], (function(e, t, s) {
    "use strict"
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0
    e.default = {
        ...
        initialize() {
            s.default.reopen({
                enable_accepted_answers: (0, t.computed)("custom_fields.enable_accepted_answers", {
                    get(e) {
                        return "true" === (0, t.get)(this.custom_fields, e)
                    }
                })
            })
        }
    ...
    e.default = t.default.extend({
        ...
        emptyState() {
            ...
            let t, o
            return this.isCurrentUser(e) ? (t = s.default.t("solved.no_solved_topics_title"), o = s.default.t("solved.no_solved_topics_body")) : (t = s.default.t("solved.no_solved_topics_title_others", {
                username: e.username
            }), o = ""), {
                title: t,
                body: o
...
})), define("discourse/plugins/discourse-solved/discourse/templates/connectors/topic-after-cooked/solved-panel", ["exports", "ember-this-fallback/deprecations-helper", "@ember/template-factory"], (function(e, t, s) {
    "use strict"
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0
...
})), define("discourse/plugins/discourse-solved/discourse/templates/connectors/topic-navigation/no-answer", ["exports", "ember-this-fallback/deprecations-helper", "@ember/template-factory"], (function(e, t, s) {
    "use strict"
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0
...
})), define("discourse/plugins/discourse-solved/discourse/templates/connectors/user-card-metadata/accepted-answers", ["exports", "ember-this-fallback/deprecations-helper", "@ember/template-factory"], (function(e, t, s) {
    "use strict"
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0
...
//# sourceMappingURL=discourse-solved-8675da95b8ab38cf2fc00032c5e16e348c83056c5c6b51bf268af64c48d0207b.map
//!
