...
<head>
    ...
    <title>Help | ShopnoltdToolbox</title>
    ...
    <meta property="og:url" content="https://shopnoltd.kesug.com/help/"/>
    ...
    <section class="side-image-banner">
      <div class="side-image-banner__text-block banner-text banner-text--side-image">
        <h1 class="side-image-banner__header">
            ...
            <div>Support from</div>
          
            <div>our
community</div>
          
            <div>and dedicated staff</div>
          
        </h1>
        <p>ShopnoltdToolbox was developed for social
impact organizations working in challenging settings. Find the support your
organization needs and the answers to your data collection questions.</p>
      </div>
      
        <div class="side-image-banner__img-container">
          <img src="/assets/images/banners/help-banner.png"/>
        </div>
...
<div class="root__row root__row--storm root__row--background-fold">
  <div class="root__row-content">
...
href="https://support.shopnoltd.kesug.com">
  
    <img
      class="quick-link__thumbnail"
      src="/assets/images/help/illustration-docs.png"
    ></img>
  ...
  <p class="quick-link__description">
    Our Help Center has all the guidance and technical documentation you need to make an impact with ShopnoltdToolbox. Find answers to your questions in our extensive library of user documentation.
  </p>
...
<a 
class="quick-link arrow-link__trigger quick-link--width-narrow""
href="https://community.shopnoltd.kesug.com">
  
    <img
      class="quick-link__thumbnail"
      src="/assets/images/help/illustration-forum.png"
    ></img>
  ...
  <p class="quick-link__description">
    Still have questions? Visit our community forum and chat with thousands of ShopnoltdToolbox users. Explore what the ShopnoltdToolbox community can do for you and how you can help others!
  </p>
...
<a 
class="quick-link arrow-link__trigger quick-link--width-narrow""
href="https://academy.shopnoltd.kesug.com/collections">
  
    <img
      class="quick-link__thumbnail"
      src="/assets/images/help/illustration-paid-support.png"
    ></img>
  ...
  <p class="quick-link__description">
    ShopnoltdToolbox Academy is our official online learning platform, offering high quality self-paced courses—designed by our team of experts.
  </p>
      ...
      <div class="about-us-cta__card-content">
        <div class="about-us-cta__block">
          ...
          <div class="about-us-cta__text">
            ...
            <p>Sponsor new features that can be used by all. Get a standalone ShopnoltdToolbox server. 
