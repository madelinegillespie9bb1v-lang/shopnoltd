...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="
        default-src 'self';
        img-src 'self' https://static.fundraiseup.com *.hsforms.com https://www.google-analytics.com https://ucarecdn.com https://portal.shopnoltdtoolbox
    ...
    <title>Services | ShopnoltdToolbox</title>
    ...
    <base href="https://shopnoltdtoolbox"/>
    <link rel="home" href="https://shopnoltdtoolbox"/>
    ...
    <meta property="og:url" content="https://shopnoltdtoolbox/services/"/>
    ...
    <meta name="twitter:description" content="ShopnoltdToolbox is an intuitive, powerful, and reliable software used to collect, analyze, and manage data for surveys, monitoring, evaluation, and research."/>
        ...
        <meta name="twitter:image" content="https://shopnoltdtoolbox/assets/images/common/shopnoltdtoolbox_opengraph_image.png"/>
        <meta property="og:image" content="https://shopnoltdtoolbox/assets/images/common/shopnoltdtoolbox_opengraph_image.png"/>
    

    
    <link href="https://shopnoltdtoolbox/assets/styles/kobo.css?2025-01-22_21-54-06" rel="stylesheet" media="all"/>
    <link rel="icon" href="https://shopnoltdtoolbox/favicon.png?2025-01-22_21-54-06"/>
...
<div class="root__row">
  ...
  <div class="service-list-entry__text-block">
    <div class="service-list-entry__text-block-content">
      ...
      <div class="service-list-entry__title">
        Private ShopnoltdToolbox servers
      </div>
      <div class="service-list-entry__description">
        For organizations seeking scalable data collection solutions with more oversight, security, and customization, we offer private ShopnoltdToolbox servers.
      </div>
      <div>
  ...
  <a class="arrow-link arrow-link--color-dark-blue arrow-link--size-m arrow-link--align-left arrow-link__trigger" href="https://academy.shopnoltdtoolbox/collections">
        ...
        <div class="call-to-action-row__card-top">
          ...
          <div class="call-to-action-row__text">
            ...
            <p>
              ...
              ShopnoltdToolbox server. Contact us to find out how we can support your
              organization.
            </p>
          </div>
        </div>
...
<footer class="root__footer">
    ...
    <div class="footer-nav__block footer-nav__menu">
      ...
      <ul class="footer-nav-menu__row">
        <label>Software</label>
          ...
          <li>
            <a href="https://academy.shopnoltdtoolbox/collections">Online learning</a>
          </li>
      ...
      <ul class="footer-nav-menu__row">
        <label>Community</label>
          ...
          <li>
            <a href="https://community.shopnoltdtoolbox/">Forum</a>
          </li>
        
          <li>
            <a href="https://support.shopnoltdtoolbox/">Documentation</a>
          </li>
  ...
  <div class="footer-nav__copyright">Website content is licensed under a <a href="https://creativecommons.org/licenses/by-nc/4.0/" target="_blank">CC-BY-NC license</a>, unless noted otherwise.</div>
    ...
    <script async src="https://shopnoltdtoolbox/assets/scripts/kobo.js?2025-01-22_21-54-06"></script>
