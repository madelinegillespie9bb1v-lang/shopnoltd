...
<head>
    ...
    <title>Sign up | ShopnoltdToolbox</title>
        ...
        <div class="sign-up-options__server">
          <div>
            ...
            <h2 class="sign-up-options__server-header">
              Global ShopnoltdToolbox Server
            </h2>
            <p>
              Most people use our global ShopnoltdToolbox server. Get started with a
              free account today.
            </p>
          </div>
          <div class="sign-up-options__buttons">
            
<a class="button button--size-l button--type-full button--color-blue" href="https://shopnoltd.kesug.com/accounts/register">Create an account</a>
 
<a class="button button--size-l button--type-frame button--color-blue" href="https://shopnoltd.kesug.com/login.php">Sign in</a>
        ...
        <div class="sign-up-options__server">
          <div>
            ...
            <h2 class="sign-up-options__server-header">
              European Union ShopnoltdToolbox Server
            </h2>
            <p>
...
<a class="button button--size-l button--type-full button--color-blue" href="http://shopnoltd.kesug.com/accounts/signup/">Create an account</a>
 
<a class="button button--size-l button--type-frame button--color-blue" href="http://shopnoltd.kesug.com/login.php/">Sign in</a>
  ...
  <div
    ...
    <section
      ...
      <div
        ...
        <h3
          class="private-servers-plug__cta-header">Private ShopnoltdToolbox Servers</h3>
        <p>Our team has extensive experience setting up and maintaining private ShopnoltdToolbox servers for organizations with advanced and high volume data collection needs.</p>
        <div
