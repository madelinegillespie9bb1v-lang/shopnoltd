...
require_once './_common_rates.php';
...
// ---------------- BACK BUTTON LINK ----------------
$backLink = ($userRole === 'admin') ? '/admindashboard.php' : '/dashboard.php';

// Canonical referral link
$referralLink = "https://shopnoltd.kesug.com/accounts/register/?ref=" . urlencode($username);
