...
export default class Info extends Component {
    ...
    siteSettings;
    get showPM() {
        return (!this.args.topicInfo.is_warning && this.args.topicInfo.isPrivateMessage);
    }
    get totalParticipants() {
        return ((this.args.topicInfo.details.allowed_users ? .length || 0) + (this.args.topicInfo.allowed_groups ? .length || 0));
    }
    get maxExtraItems() {
        return this.args.topicInfo.tags ? .length > 0 ? 5 : 10;
    }
    get twoRows() {
        return (this.tags ? .length || this.showPM || this.siteSettings.topic_featured_link_enabled);
    }
    get tags() {
    ...
    get participants() {
        ...
        return participants1.slice(0, this.maxExtraItems);
    }
    get pmHref() {
