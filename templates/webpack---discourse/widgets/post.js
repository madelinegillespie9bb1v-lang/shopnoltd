...
import {
    dateNode
} from "discourse/helpers/node";
import autoGroupFlairForUser from "discourse/lib/avatar-flair";
import {
    relativeAgeMediumSpan
    ...
    html(attrs) {
        ...
        if (attrs.notice.type === "new_user") {
            return [
                ...
                h("p", I18n.t("post.notice.new_user", {
                    user
                })),
            ];
        }
        ...
        if (attrs.notice.type === "returning_user") {
            ...
            return [
                ...
                h("p", I18n.t("post.notice.returning_user", {
                    user,
                    time
                })),
            ];
