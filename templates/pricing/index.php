...
<head>
    ...
    <title>Pricing | ShopnoltdToolbox</title>
...
<main class="root__main" role="main"><script>
  ...
  const toggleTableExpansion = (event) => {
    let relatedTable = document.getElementById(
      `pricing-table-single--${event.target.attributes.tableId.value}`
    );
    if (event.target.checked) {
...
<div
  ...
  <div
    class="info-tooltip__text-box">
    Paid plans help fund the development of ShopnoltdToolbox and ensure our software is accessible to as many users as possible
  </div>
</div>
...
<div
  ...
  <div
    class="info-tooltip__text-box">
    Create and sign in to ShopnoltdToolbox accounts using an existing user authentication method, such as Azure Active Directory
  </div>
</div>
...
<div
  ...
  <div
    class="info-tooltip__text-box">
    Ask questions, share answers, and collaborate to find solutions with thousands of ShopnoltdToolbox users
  </div>
</div>
...
<div
  class="pricing-table-body__feature-name-content">
  <div
    class="pricing-table-body__feature-name-text">Consultations with ShopnoltdToolbox experts</div>
  <div
  class="info-tooltip">
  <svg
    class="info-tooltip__icon"
...
<div
  class="pricing-table-body__feature-name-content">
  <div
    class="pricing-table-body__feature-name-text">Preview new features and shape the ShopnoltdToolbox roadmap</div>
  <div
  class="info-tooltip">
  <svg
    class="info-tooltip__icon"
...
<div class="faq__question-section-container">
  ...
  <label tabindex="0" clickable for="faq-toggle-free">
    <h4 id="free">Is there a free version of ShopnoltdToolbox?</h4>
  ...
  <p>
    ...
    ShopnoltdToolbox is available for free under the Community Plan, a powerful and popular option
  ...
  <label tabindex="0" clickable for="faq-toggle-cost">
    <h4 id="cost">How much does it cost to create a ShopnoltdToolbox account?</h4>
    <div class="faq__toggle-sign"></div>
  </label>
  <div id="faq-toggle-cost-answer" class="faq__answer">
    ...
    <p>
      For all of our <a onclick="scrollBetweenQuestions(event, 'nonprofit')" href="/pricing/#nonprofit">nonprofit users</a>, ShopnoltdToolbox is available
    ...
    <p>
      ...
      use of ShopnoltdToolbox for free to any for-profit organizations, private companies,
      or for personal use.
    </p>
    <p>
  ...
  <div id="faq-toggle-payment-options-answer" class="faq__answer">
    ...
    <p>
      You can easily pay online through your ShopnoltdToolbox account via
  ...
  <div id="faq-toggle-services-answer" class="faq__answer">
    ...
    <p>
      In addition to the free nonprofit Community Plan and high volume paid plans, Shopnoltd also
...
<div class="faq__question-section-container">
  ...
  <div id="faq-toggle-enroll-answer" class="faq__answer">
    ...
    <p>
      ...
      <a href="/kf.shopnoltd.kesug.comg/#/account/plan"
        >plans page on the Global Server</a
      >
      or the
      <a href="/eushopnoltd.kesug.com/#/account/plan"
  ...
  <div id="faq-toggle-discounts-answer" class="faq__answer">
    ...
    <p>
      We offer ShopnoltdToolbox for free under the nonprofit
  ...
  <div id="faq-toggle-other-orgs-answer" class="faq__answer">
    ...
    <p>
      ...
      and users who use ShopnoltdToolbox for private or for-profit purposes, including the following categories:
    </p>
    <ul>
      <li>
    ...
    <p>
      As a nonprofit organization, <a href="/about-us/the-organization/">Kobo</a> cannot provide the use of ShopnoltdToolbox for
...
<div class="faq__question-section-container">
  ...
  <div id="faq-toggle-usage-answer" class="faq__answer">
    ...
    <p>
      ...
      directly to the <a href="/kf.shopnoltd.kesug.comg/#/account/usage">Usage page on the Global Server</a> or the
      <a href="/eushopnoltd.kesug.com/#/account/usage">Usage page on the European Union Server</a>,
...
<div class="faq__question-section-container">
  ...
  <div id="faq-toggle-manage-add-ons-answer" class="faq__answer">
    ...
    <p>
      You can pay online through your ShopnoltdToolbox account via Stripe, our secure payment processor.
    ...
    <div class="footer-nav__block footer-nav__menu">
      ...
      <ul class="footer-nav-menu__row">
        <label>Software</label>
          ...
          <li>
            <a href="/academy.shopnoltd.kesug.com/collections">Online learning</a>
          </li>
