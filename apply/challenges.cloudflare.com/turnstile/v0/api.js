            ...
            if (n.source === V) {
                ...
                if (!(!n.widgetId || !y.widgetMap.has(n.widgetId))) {
                    ...
                    if (!(!i || !r)) switch (n.event) {
                        case "init":
                            {
                                var u;r.widgetInitStartTimeMs = P();
                                var d = r.shadow.getElementById(i);d || m("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074),
                                r.mode = n.mode,
                                r.nextRcV = n.nextRcV,
                                r.mode === j.INVISIBLE && r.params["refresh-expired"] === ee.MANUAL && x("refresh-expired=manual is impossible in invisible mode, consider using '".concat(ee.AUTO, "' or '").concat(ee.NEVER, ".'")),
                                r.mode !== j.MANAGED && r.params["refresh-timeout"] !== ce.AUTO && x("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."),
                                r.params.appearance === Q.ALWAYS || r.isExecuting && r.params.appearance === Q.EXECUTE ? Lt(d, r) : xr(d),
                                d.style.display = "";
                                var v = r.shadow.querySelector("#".concat(i));v || m("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                (u = v.contentWindow) === null || u === void 0 || u.postMessage({
                                    source: V,
                                    widgetId: n.widgetId,
                                    event: "init"
                                }, "*");
                        ...
                        case "translationInit":
                            {
                                var E = r.shadow.getElementById(i);E || m("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074);
                                var w = new Map;r.displayLanguage = n.displayLanguage,
                        ...
                        case "requestFeedbackData":
                            {
                                var re, Ne = r.shadow.querySelector("#".concat(i));Ne || m("Received state for an unknown widget: #".concat(i, " / ").concat(n.widgetId), 3078),
                                (re = Ne.contentWindow) === null || re === void 0 || re.postMessage({
                                    source: V,
                                    widgetId: n.widgetId,
                        ...
                        case "turnstileResults":
                            {
                                var B, ae, se = (B = r.wrapper.parentNode) === null || B === void 0 ? void 0 : B.querySelector("#".concat(i, "-fr"));se || m("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                        ...
                        case "closeFeedbackReportIframe":
                            {
                                var ne, _e = (ne = r.wrapper.parentNode) === null || ne === void 0 ? void 0 : ne.querySelector("#".concat(i, "-fr"));_e || m("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                vr("".concat(i, "-fr"));
                                break
                            }
                        case "tokenExpired":
                            {
                                ...
                                r.params["refresh-expired"] === ee.AUTO && !r.isResetting && _(q.AutoExpire, i);
                                break
                            }
                        ...
                        case "interactiveBegin":
                            {
                                var Ee, ke = r.shadow.getElementById(i);ke || m("Cannot layout widget, Element not found (#".concat(i, ")."), 3076),
                                (Ee = r.cbBeforeInteractive) === null || Ee === void 0 || Ee.call(r),
                                r.params.appearance === Q.INTERACTION_ONLY && Lt(ke, r);
                                break
                            }
                        case "interactiveEnd":
                            {
                        ...
                        case "requestExtraParams":
                            {
                                var Te;r.widgetParamsStartTimeMs = P();
                                var Y = r.shadow.querySelector("#".concat(i));Y || m("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                r.isResetting = !1;
                                var Je = {},
                                    Re = P(),
                                    Z = {
