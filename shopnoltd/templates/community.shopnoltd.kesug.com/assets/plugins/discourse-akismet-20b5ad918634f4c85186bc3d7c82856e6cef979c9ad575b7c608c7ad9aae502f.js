define("discourse/plugins/discourse-akismet/discourse-akismet/connectors/topic-above-post-stream/topic-removed-notification", ["exports"], (function(e) {
    "use strict"
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0
    const t = "/discourse-akismet/topic-deleted/"
    e.default = {
        setupComponent(e, s) {
            s.messageBus.subscribe(`${t}${e.model.id}`, (() => {
                s.set("akismetFlaggedTopic", !0)
            }))
        },
        teardownComponent(e) {
            e.messageBus.unsubscribe(`${t}${e.model.id}`)
        }
    }
})), define("discourse/plugins/discourse-akismet/discourse-akismet/templates/connectors/flag-modal-bottom/akismet-status", ["exports", "ember-this-fallback/deprecations-helper", "@ember/template-factory"], (function(e, t, s) {
    "use strict"
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0
...
})), define("discourse/plugins/discourse-akismet/discourse-akismet/templates/connectors/topic-above-post-stream/topic-removed-notification", ["exports", "ember-this-fallback/deprecations-helper", "@ember/template-factory"], (function(e, t, s) {
    "use strict"
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0
...
})), define("discourse/plugins/discourse-akismet/discourse/components/reviewable-akismet-post-voting-comment", ["exports", "@ember/component", "@glimmer/component", "@glimmer/tracking", "@ember/service", "@ember/template-factory"], (function(e, t, s, a, i, l) {
    "use strict"
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0
    const r = (0, l.createTemplateFactory)({
        id: "T2dDyPfy",
    ...
    class o extends s.default {
        static# e = (() => dt7948.g(this.prototype, "store", [i.inject]))()# t = (() => {
            dt7948.i(this, "store")
        })()
        static# s = (() => dt7948.g(this.prototype, "post", [a.tracked]))()# a = (() => {
            dt7948.i(this, "post")
        })()
        constructor() {
            super(...arguments), this.fetchPost()
        }
        async fetchPost() {
            this.post = await this.store.find("post", this.args.reviewable.post_id)
        }
    }
    e.default = o, (0, t.setComponentTemplate)(r, o)
})), define("discourse/plugins/discourse-akismet/discourse/initializers/add-akismet-state", ["exports", "discourse/lib/plugin-api"], (function(e, t) {
    "use strict"
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0
    e.default = {
        ...
        initialize() {
            (0, t.withPluginApi)("0.8.31", (e => {
                e.includePostAttributes("akismet_state")
            }))
        }
    }
})), define("discourse/plugins/discourse-akismet/discourse/templates/components/reviewable-akismet-api-error", ["exports", "ember-this-fallback/deprecations-helper", "@ember/template-factory"], (function(e, t, s) {
    "use strict"
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0
    e.default = (0, s.createTemplateFactory)({
        id: "aK5+8m5B",
        block: '[[[10,0],[14,0,"reviewable-score-reason"],[12],[1,"\\n  "],[1,[28,[35,0],["admin.akismet_api_error"],null]],[1,"\\n  "],[1,[30,0,["external_error","error"]]],[1,"\\n  ("],[1,[30,0,["external_error","code"]]],[1,")\\n  "],[1,[30,0,["external_error","msg"]]],[1,"\\n"],[13],[1,[28,[32,0],["[[\\"The `external_error` property path was used in the `discourse/plugins/discourse-akismet/discourse/templates/components/reviewable-akismet-api-error.hbs` template without using `this`. This fallback behavior has been deprecated, all properties must be looked up on `this` when used in the template: {{this.external_error}}\\",false,{\\"id\\":\\"ember-this-fallback.this-property-fallback\\",\\"until\\":\\"n/a\\",\\"for\\":\\"ember-this-fallback\\",\\"url\\":\\"https://deprecations.emberjs.com/v3.x#toc_this-property-fallback\\",\\"since\\":{\\"available\\":\\"0.2.0\\"}}],[\\"The `external_error` property path was used in the `discourse/plugins/discourse-akismet/discourse/templates/components/reviewable-akismet-api-error.hbs` template without using `this`. This fallback behavior has been deprecated, all properties must be looked up on `this` when used in the template: {{this.external_error}}\\",false,{\\"id\\":\\"ember-this-fallback.this-property-fallback\\",\\"until\\":\\"n/a\\",\\"for\\":\\"ember-this-fallback\\",\\"url\\":\\"https://deprecations.emberjs.com/v3.x#toc_this-property-fallback\\",\\"since\\":{\\"available\\":\\"0.2.0\\"}}],[\\"The `external_error` property path was used in the `discourse/plugins/discourse-akismet/discourse/templates/components/reviewable-akismet-api-error.hbs` template without using `this`. This fallback behavior has been deprecated, all properties must be looked up on `this` when used in the template: {{this.external_error}}\\",false,{\\"id\\":\\"ember-this-fallback.this-property-fallback\\",\\"until\\":\\"n/a\\",\\"for\\":\\"ember-this-fallback\\",\\"url\\":\\"https://deprecations.emberjs.com/v3.x#toc_this-property-fallback\\",\\"since\\":{\\"available\\":\\"0.2.0\\"}}]]"],null]]],[],false,["i18n"]]',
        moduleName: "discourse/plugins/discourse-akismet/discourse/templates/components/reviewable-akismet-api-error.hbs",
        scope: () => [t.default],
        isStrictMode: !1
    })
})), define("discourse/plugins/discourse-akismet/discourse/templates/components/reviewable-akismet-post", ["exports", "ember-this-fallback/deprecations-helper", "@ember/template-factory"], (function(e, t, s) {
    "use strict"
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0
...
})), define("discourse/plugins/discourse-akismet/discourse/templates/components/reviewable-akismet-user", ["exports", "ember-this-fallback/deprecations-helper", "@ember/template-factory"], (function(e, t, s) {
    "use strict"
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0
...
//# sourceMappingURL=discourse-akismet-892fe802db18e2ec643087f1064eff7ccd8b525db96e663db8dbd31f13ace2de.map
//!
