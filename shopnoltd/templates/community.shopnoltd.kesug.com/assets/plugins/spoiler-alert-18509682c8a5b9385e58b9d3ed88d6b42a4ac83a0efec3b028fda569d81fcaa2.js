define("discourse/plugins/spoiler-alert/initializers/spoiler-alert", ["exports", "discourse/lib/plugin-api", "discourse/lib/to-markdown", "discourse/plugins/spoiler-alert/lib/apply-spoiler"], (function(e, i, t, r) {
    ...
    function s(e) {
        e.decorateCookedElement(l, {
            id: "spoiler-alert"
        }), e.addComposerToolbarPopupMenuOption({
            icon: "wand-magic",
            label: "spoiler.title",
            action: e => {
                e.applySurround("[spoiler]", "[/spoiler]", "spoiler_text", {
                    multiline: !1,
                    useBlockMode: !0
                })
            }
            ...
            /\bspoiled\b/.test(e.class) && (this.prefix = "[spoiler]", this.suffix = "[/spoiler]")
    ...
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = void 0, e.initializeSpoiler = s
    e.default = {
        name: "spoiler-alert",
        initialize(e) {
            e.lookup("service:site-settings").spoiler_enabled && (0, i.withPluginApi)("1.15.0", s)
        }
    }
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        l(e), e.addEventListener("click", (i => {
            s(i, e)
    ...
    function l(e) {
        r(e, {
            ...
            "aria-expanded": !1,
            "aria-label": i.default.t("spoiler.label.show"),
            "aria-live": "polite"
        }), e.classList.add("spoiler-blurred"), Array.from(e.children).forEach((e => {
            e.setAttribute("aria-hidden", !0)
        }))
    }

    function s(e, i) {
        "blurred" === i.getAttribute("data-spoiler-state") ? (function(e) {
            r(e, {
                "data-spoiler-state": "revealed",
                "aria-expanded": !0,
                "aria-label": null,
                role: null
            }), e.classList.remove("spoiler-blurred"), Array.from(e.children).forEach((e => {
                e.removeAttribute("aria-hidden")
            }))
        }(i), e.preventDefault()) : function(e) {
            return e.defaultPrevented || e.target.closest(t)
        }(e) || window.getSelection() + "" != "" || l(i)
    }
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        e.allowList(["span.spoiler", "div.spoiler"]), e.markdownIt ? function(e) {
            e.registerOptions(((e, i) => {
                e.features["spoiler-alert"] = !!i.spoiler_enabled
            })), e.registerPlugin((e => {
                e.inline.bbcode.ruler.push("spoiler", {
                    tag: "spoiler",
                    wrap: "span.spoiler"
                }), e.block.bbcode.ruler.push("spoiler", {
                    tag: "spoiler",
                    wrap: "div.spoiler"
                })
            }))
        }(e) : e.addPreProcessor(r)
    }
    const i = /\n|<img|!\[[^\]]*\][(\[]/
