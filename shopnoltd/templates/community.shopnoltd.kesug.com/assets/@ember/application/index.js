    ...
    class Application extends _engine.default {
        ...
        */
        boot() {
            ...
            (false && !(this._bootPromise) && (0, _debug.assert)('has boot promise', this._bootPromise));
            return this._bootPromise;
        }
        /**
        ...
        */
        reset() {
            ...
            function handleReset() {
                (false && !(instance) && (0, _debug.assert)('expected instance', instance));
        ...
        */
        didBecomeReady() {
            ...
            (false && !(this._bootResolver) && (0, _debug.assert)('expected _bootResolver', this._bootResolver));
            try {
