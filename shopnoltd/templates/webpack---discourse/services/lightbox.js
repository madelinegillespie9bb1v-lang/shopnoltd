...
} from "discourse/lib/implicit-injections";
import {
...
import {
    processHTML
} from "discourse/lib/lightbox/process-html";
import {
    isDocumentRTL
...
export default class LightboxService extends Service {
    ...
    @bind
    async onLightboxItemWillChange({
        currentItem
    }) {
