...
export default class SidebarSection extends Component {
    ...
    collapsedSidebarSectionKey = getCollapsedSidebarSectionKey(this.args.sectionName);
    constructor() {
        super(...arguments);
    ...
    @bind
    expandIfActive(transition1) {
        if (transition1 ? .isAborted) {
            return;
        }
    ...
    get displaySectionContent() {
        ...
        return !this.sidebarState.collapsedSections.has(this.collapsedSidebarSectionKey);
    }
    @action
    toggleSectionDisplay(_1, event1) {
    ...
    @action
    handleMultipleHeaderActions(id1) {
        this.args.headerActions.find((headerAction1) => headerAction1.id === id1).action();
    }
    get headerCaretIcon() {
