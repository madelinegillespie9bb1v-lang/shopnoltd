...
import {
    headerOffset
} from "discourse/lib/offset-calculator";
import {
    nextTopicUrl,
    previousTopicUrl,
...
export {
    extraKeyboardShortcutsHelp as extraKeyboardShortcutsHelp
};
...
const DEFAULT_BINDINGS = {
    ...
    x: {
        handler: "bulkSelectItem"
    },
    "shift+d": {
        click: "#dismiss-new-bottom, #dismiss-new-top, #dismiss-topics-bottom, #dismiss-topics-top",
