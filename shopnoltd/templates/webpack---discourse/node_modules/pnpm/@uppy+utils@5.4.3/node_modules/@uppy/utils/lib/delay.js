...
export default function delay(ms, opts) {
    return new Promise((resolve, reject) => {
        ...
        opts == null || (_opts$signal2 = opts.signal) == null ? void 0 : _opts$signal2.addEventListener('abort', onabort);

        function cleanup() {
            var _opts$signal3;
            opts == null || (_opts$signal3 = opts.signal) == null ? void 0 : _opts$signal3.removeEventListener('abort', onabort);
        }
        return undefined;
    });
}