...
import {
    search as searchCategoryTag
} from "discourse/lib/category-tag-search";
import {
    setTransient
...
export default class FullPageSearchController extends Controller {
    ...
    init() {
        ...
        const searchTypes = [{
                name: I18n.t("search.type.default"),
        ...
        this.sortOrders = [{
                name: I18n.t("search.relevance"),
                id: 0
            },
            {
                name: I18n.t("search.latest_post"),
                id: 1,
                term: "order:latest"
            },
            {
                name: I18n.t("search.most_liked"),
                id: 2,
                term: "order:likes"
            },
            {
                name: I18n.t("search.most_viewed"),
                id: 3,
                term: "order:views"
            },
            {
    ...
    resultCountLabel(count, term) {
        ...
        return I18n.t("search.result_count", {
            count,
            plus,
            term
        });
    ...
    searchResultPosts(posts, additionalSearchResults) {
        if (additionalSearchResults ? .list ? .length > 0) {
            return reciprocallyRankedList(
                [posts, additionalSearchResults.list], ["topic_id", additionalSearchResults.identifier]
            );
        } else {
            return posts;
        }
